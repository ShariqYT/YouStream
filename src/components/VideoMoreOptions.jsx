    ...
    return (
        <>
            <div className='options relative z-[1010]'>
                ...
                {showOption && (
                    <div className='bg-white border border-[#35b7ff] overflow-hidden w-fit whitespace-nowrap absolute right-10 -top-32 md:top-0 rounded-2xl drop-shadow-[0_0px_20px_rgba(0,0,0,0.2)] flex flex-col'>
