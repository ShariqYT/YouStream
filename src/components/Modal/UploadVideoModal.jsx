...
const UploadVideoModal = ({ onUpload }) => {
    ...
    return (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-start z-[10002] bg-white drop-shadow-[0_0_20px_rgba(0,0,0,0.25)] border-2 border-[#35b7ff] w-[100rem] h-[45rem] rounded-xl">
            ...
            <div className="flex flex-col gap-4 justify-center items-center h-full">
                ...
                <div className="flex flex-col items-center">
                    <p>Select files to upload (max size 512MB)</p>
                    <p className="text-neutral-400 text-sm">Your videos will be private until you publish them.</p>
                </div>
